...
generated quantities {
  ...
  // TO DO: should treat the intercept as a binary variable
   ...
   for (i in 1:L+1) {
      ...
      if(i == 8 || i == 9) { // binary
	    ...
	    if (i == 12) { // combined effect of linear and squared term. need to subtract off the squared term for x and add it back for (x+epsilon)**2
